...
[_WORKMAN] = LAYOUT_split_3x5_3( \
  ...
  KC_Z,    KC_X,    KC_M,    KC_C,    KC_V,         KC_K,    KC_L,    KC_COMM, KC_DOT,  KC_SLSH, \
                    KC_LCTL, KC_LSFT, KC_SPC,       KC_ENT,  KC_BSPC, MO(RAISE)                 \
),
...
[_RAISE] = LAYOUT_split_3x5_3( \
  ...
  KC_TAB,    KC_LEFT, KC_UP, KC_RGHT,   KC_LBRC,      KC_RBRC, KC_MINS, KC_QUOT,  KC_MINS, KC_EQL, \
  KC_GRV, KC_PGUP,  KC_DOWN, KC_PGDN, _______,      _______, _______, _______, KC_TRNS,  KC_BSLS, \
                    KC_LALT, MO(LOWER), KC_ESC,      KC_RGUI, _______, _______                    \
),
